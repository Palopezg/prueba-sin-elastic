...
export class SegmentoDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('pruebaSinElasticApp.segmento.delete.question'));
...
export default class SegmentoComponentsPage {
  ...
  async deleteSegmento() {
    ...
    expect(await segmentoDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/pruebaSinElasticApp.segmento.delete.question/);
