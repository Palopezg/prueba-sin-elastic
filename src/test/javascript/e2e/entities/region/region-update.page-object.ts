...
export default class RegionUpdatePage {
  pageTitle: ElementFinder = element(by.id('pruebaSinElasticApp.region.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  descripcionInput: ElementFinder = element(by.css('input#region-descripcion'));
  valorInput: ElementFinder = element(by.css('input#region-valor'));
