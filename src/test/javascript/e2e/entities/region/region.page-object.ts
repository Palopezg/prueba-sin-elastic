...
export class RegionDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('pruebaSinElasticApp.region.delete.question'));
...
export default class RegionComponentsPage {
  ...
  async deleteRegion() {
    ...
    expect(await regionDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/pruebaSinElasticApp.region.delete.question/);
